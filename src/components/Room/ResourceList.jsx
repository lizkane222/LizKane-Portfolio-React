...
const ResourceList = () => {
    ...
    const resourceItems = resourceArray.map(resource => {return <Resource name={resource.name} namePrint={resource.namePrint} description1={resource.description1} description2={resource.description2} description3={resource.description3} iframe={resource.iframe} emblem={resource.emblem} logo={resource.logo} category={resource.category}/>
    })
