...
const ProjectList = () => {
    ...
    const MBCrunchStockImg = "https://i.imgur.com/XhjQRjC.jpg?1";
    const NoshStockImg = "blob:https://imgur.com/63a885e9-8e1e-40ee-960a-8627cd8faff5";
    ...
    const projectArray = [
    {name: "Ekseed", logo:EkseedLogo, stockImg:"EkseedStockImg", stack:"MERN", group:"solo", github:EkseedGitHub, github2:EkseedGitHub2, proDescription:EkseedDescription, proGallery:EkseedGalleryArray, x:100, y:100, width:100, zindex:1, proId:"Ekseed"},
    {name: "Deviant", logo: DeviantLogo, stockImg:"DeviantStockImg", stack:"JS", group:"solo", proGallery:DeviantGalleryArray, github:DeviantGitHub, github2:"", proDescription: DeviantDescription,  x:200, y: 200, width: 100, zindex:1, proId:"Deviant", },
    {name: "Minifi", logo: MinifiLogo, stockImg:"MinifiStockImg", stack:"MEN", group:"solo", proGallery:MinifiGalleryArray, proDescription: MinifiDescription, x:300, y: 200, width: 100, zindex:1, proId:"Minifi", github:MinifiGitHub, github2:"",},
    {name: "MBCrunch", logo:MBCrunchLogo, stockImg:"MBCrunchStockImg", stack:"MEN", group:"solo", proGallery:MBCrunchGalleryArray, proDescription:MBCrunchDescription, x:300, y: 300, width: 100, zindex:1, proId:"MBCrunch", github:MBCrunchGitHub, github2:"",},
    {name: "Nosh", logo: NoshLogo, stockImg:"NoshStockImg", stack:"MEN", group:"collab", proGallery:NoshGalleryArray, proDescription:NoshDescription, x:400, y: 400, width: 100, zindex:1, proId:"Nosh", github:NoshGitHub, github2:"",},
    {name: "Wayfarer", logo:WayfarerLogo, stockImg:"WayfarerStockImg", stack:"Django-Python", group:"collab", proGallery:WayfarerGalleryArray, proDescription:WayfarerDescription, x:500, y: 500, width: 100, zindex:1, proId:"Wayfarer", github:WayfarerGitHub, github2:""}]
