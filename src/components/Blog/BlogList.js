...
const BlogPostNomad = [{
 ...
 blogP5: "I love comfort. Who doesn’t? Growing up playing seasonal sports year round, I developed an edge I think many athletes do which is to push yourself through the strain of training to gain strength, endurance, and ultimately reach a goal. I sought this strain out in every area of my life, always pushing myself to be better than I was yesterday. The goal was not always in sight but that exertion of will over difficult tasks, events, and circumstances was my preseason, and if every season is a new sport then it’s always preseason. This edge has contributed to my inflated dreams that seem daunting for some but completely tangible for myself.",
 blogP6: "I set a goal to attend university outside of my hometown, to move to France and support myself while doing so, to obtain a Masters degree, to delve into an immersive software engineering bootcamp. Each were at the time some of the most straining experiences of my life, mostly due to the fact that they took me out of my zone of comfort and brought me into a place that forced me to live each area of my life intentionally in order to reach that goal. It’s not so much that the goal is the goal. I know it’s a strange thing to say, but the goal is the celestial object with a strong enough gravitational force to send my life orbiting along its axis of purpose. Directionally forward enough to pull my every life aspect into purpose and intentionality.",
 blogP7: "Belonging elsewhere is my way setting my heart, mind, and body towards the future; sometimes a distant future that seems to grand an expectation for so many in my life… but there’s nothing like being aboard a rocket that is only subject to the forces of your own deepest desires. What good is rocket fuel if not to propel you further and faster than the expectations others have of you.",
 blogP8: "",
 blogP9: "",
 blogP10: "",
 blogP11: "",
...
const BlogPostAthlete = [{
 ...
 blogP2: "When I was young we play with a curiosity and joy that lends us to not question why we’re doing what we’re doing, but if we’re enjoying it. When I joined my first team sport at ten I don’t remember liking it in the last bit. But some two years later I joined the middle school volleyball team, basketball team, and softball team. Summers were spent at sports camps or watching warm Arizonan night softball games. There was a decoherence (incoherence?) between what I was doing and why I was doing it. I remember loving being around my team, a group of my friends where we had an excuse to spend hours of every weekday and some weekends playing sports. I remember loving learning how to do something new, like doing a reverse layup, rolling after digging a spike, catching a fly and throwing it home. These tasks were what I lived for.",
 blogP3: "I don’t remember a time in my life where my family didn’t make everything a competition or game. From age 6 my dad would hand me a map and we’d play ‘find that street’.  My family of six would race in our separate cars to be the first inside the house after any outing. Games were woven into every aspect of daily life, and though I fed off the competition, I actually always hated how it made me feel to win or lose. I relished in the experience of bonding through a shared hardship, often video gaming or fort building and of course the intense hide-n-seek in the dark. It took me well into my twenties to actually realize I don’t like the competition of sports but the acknowledgement of friendship gained in playing sports.",
 ...
 blogP6: "As an eleven year old I was trained to harness my anger, to increase my drive, and to always put winning first. At 18, I felt both withdrawal and release from finally ending my career as a teenage athlete. No longer needing to collide with intensely harmful forces and ideas, but finally free to discover what sports mean to me. My sweet spot, the time I felt truest, liberated, and joyful were when I was peppering in volleyball with a friend, dancing around the court with just a basketball and my headphones, being in the sun volleying tennis balls talking. These were the spaces in between, where no one usually places too much importance, where I discovered that curiosity and joy once again not needing to question why but able to just do.i",
 blogP7: "",
 blogP8: "",
 blogP9: "",
 blogP10: "",
...
const BlogPostFeminist = [{
 ...
 blogP2: "It’s an interesting idea to be a feminist in a world that all too easily narrows the field of what it means to be feminine. Every eight year old girl is told they’ll have to one day shave their legs, their armpits, and many other places all for the sake of … wait what? No one can still even give me a good explanation for this. Because it was a French trend in the 1800s? Because the further from resembling a man the closer to a woman you’d be? Because men prefer it and if you want to please a man, your boyfriend, husband, gentleman caller then you must look the part?",
